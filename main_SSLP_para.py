...
def sub_routine(o, c, u, d, h, q0, q, x_value, lambda_level, mu_level, norm_option, tol = 1e-2, cut_Dict = {}):
    # input: 
    ...
    pi_value_o, v_value_o, cutList_o = solve_lag_dual(o, c, u, d, h[o], q0[o], q[o], x_value, L_value, lambda_level, mu_level, norm_option, tol, cut_Dict[o])
