...
def sub_routine(o, h, T, W, c, y_option, x_value, lambda_level, mu_level, norm_option, tol = 1e-2, cut_Dict = {}):
    # input: 
...
if __name__ == "__main__":
    ...
    while iter_bool:
        ...
        sub_opt_results = pool.map(partial(sub_routine, h=h, T=T, W=W, c=c, y_option=y_option, x_value=x_value, lambda_level=lambda_level, 
                                           mu_level=mu_level, norm_option=norm_option, tol=1e-3, cut_Dict = cut_Dict), range(omega))
